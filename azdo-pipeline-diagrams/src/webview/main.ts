...
async function renderGraph(
  ...
  for (const edge of graph.edges) {
    ...
    line.setAttribute('x1', String(isTb ? sx + 90 : sx + 180));
    line.setAttribute('y1', String(isTb ? sy + 56 : sy + 28));
    line.setAttribute('x2', String(isTb ? tx + 90 : tx));
    line.setAttribute('y2', String(isTb ? ty : ty + 28));
